...
import type { Person } from "@/types/tracker";
...
export const PersonProgress = ({
  ...
  const handleAddAppeal = () => {
    const time = parseFloat(reviewTime);
            ...
            <DialogContent>
              ...
              <div className="space-y-4 py-4">
                <div className="space-y-2">
                  <Label htmlFor="reviewTime">Tempo de revisão (minutos)</Label>
                  <Input
                    id="reviewTime"
                    type="number"
                    min="0"
                ...
                <Button
                  ...
                  className="w-full"
                  disabled={!reviewTime || parseFloat(reviewTime) <= 0}
                >
                  Adicionar Appeal
                </Button>
              </div>
